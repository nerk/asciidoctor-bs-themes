...
To view the generated files, start a webserver with directory 'test' as the root directory. For example, you
may use python. Invoke the following command from directory 'test':

 $ python -m SimpleHTTPServer
 
Now enter the following URL in your browser:

 http://localhost:8000/output/test_cosmo.html 
